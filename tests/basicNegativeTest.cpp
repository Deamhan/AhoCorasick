...
typedef std::vector<char> StringClass;
typedef AhoCorasick::Match<StringClass> StringMatch;

static const StringClass text = { 1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 9, 8, 7, 6, 5, 4, 3, 2, 1, (char)(- 1), (char)(-2), 34};
static std::vector<StringClass> strings = { {5, 6, 7}, {5}, {6, 7}, {3, 4, 5, 6, 7}, {7, 7, 7}, {7, 6}, {(char)(-1), (char)(-2)} };
